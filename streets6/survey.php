  		...
  		<div class="row">
  			<div id="games" class="col-md-8 col-md-offset-2">
				...
				<div class='text-center'>
					<p id='instructions' class='text-center'>In round 1, you will be shown two different scenes. Each scene will be shown for 5 minutes each. During this time, please study the scenes carefully as you will be asked detailed questions about what you saw. For example, you might be asked how many people were in the scene. Or you might be asked how many advertisements were in the scene. You won't know which questions you'll be asked until after you have studied each scene.</p>
			...
			<div id="dumq" style="display:none" class="col-md-8 col-md-offset-2">
  				<p>Please answer the following questions about the scene you just viewed.</p>
					<div class="form-group">
    					<label for="q1" id="for1">q1</label><br/>
    					<input type="text" class="form-control" name="q1" id="q1" required>
    				        </div>
					<div class="form-group">
    					<label for="q2" id="for2">q2</label>
    					<input type="text" class="form-control" name="q2" id="q2" required>
    				        </div>
					<div class="form-group">
    					<label for="q3" id="for3">q3</label>
    					<input type="text" class="form-control" name="q3" id="q3" required>
    				        </div>
					
					<div class="form-group">
						<div class="col-sm-10 col-sm-offset-8">
							<button id="dumbut" class="btn btn-primary">Submit</button>
						</div>
					</div>
